            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5 mb-5">
                {project.technologies.map((tech) => (
                  <span
                    key={tech}
                    className="px-2 py-0.5 text-[11px] font-medium rounded-md bg-gray-100 dark:bg-white/6 text-gray-600 dark:text-[#888] border border-gray-200 dark:border-white/8"
                  >
                    {tech}
                  </span>
                ))}
